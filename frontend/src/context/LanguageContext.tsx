...
const translations: Record<Language, Record<string, string>> = {
  tr: {
    ...
    // Quiz
    quiz_back: 'GERİ',
    quiz_header_title: 'Cilt Analiz Anketi',
    ...
    quiz_next_btn: 'Sonraki Soru',
    quiz_finish_btn: 'Analizi Tamamla',
    quiz_step_counter: 'Soru',
    quiz_calculating: 'Klinik Skorunuz Hesaplanıyor...',
    quiz_result_title: 'Cilt Analizi Sonucunuz',
    quiz_result_subtitle: 'Baumann cilt tipi ve bariyer sağlığı analiziniz başarıyla tamamlandı.',
    quiz_result_type_label: 'Belirlenen Cilt Tipi',
    quiz_result_barrier_label: 'Bariyer Sağlığı',
    quiz_result_score_label: 'Bariyer Skoru',
    quiz_result_concerns_label: 'Hedeflenen Endişe',
    quiz_apply_profile_btn: 'Profili Kaydet ve Uygula',
    quiz_retake_btn: 'Anketi Baştan Çöz',
    skin_type_oily: 'Yağlı Cilt',
    skin_type_dry: 'Kuru Cilt',
    skin_type_combination: 'Karma Cilt',
    skin_type_normal: 'Normal Cilt',
    skin_type_sensitive: 'Hassas Cilt',
  },
  en: {
    ...
    profile_desc_highlight: 'Combination & Dehydrated',
    ...
    // Quiz
    quiz_back: 'BACK',
    quiz_header_title: 'Skin Analysis Quiz',
    ...
    quiz_finish_btn: 'Complete Analysis',
    quiz_step_counter: 'Question',
    quiz_calculating: 'Calculating Clinical Score...',
    quiz_result_title: 'Your Skin Analysis Result',
    quiz_result_subtitle: 'Baumann skin type and barrier health analysis completed successfully.',
    quiz_result_type_label: 'Determined Skin Type',
    quiz_result_barrier_label: 'Barrier Health Status',
    quiz_result_score_label: 'Barrier Score',
    quiz_result_concerns_label: 'Target Concern',
    quiz_apply_profile_btn: 'Save and Apply Profile',
    quiz_retake_btn: 'Restart Quiz',
    skin_type_oily: 'Oily Skin',
    skin_type_dry: 'Dry Skin',
    skin_type_combination: 'Combination Skin',
    skin_type_normal: 'Normal Skin',
    skin_type_sensitive: 'Sensitive Skin',
  },
};
